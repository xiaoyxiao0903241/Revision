        ...
        <div className="space-y-4">
          <Card containerClassName="flat-body">
            <div className="grid grid-cols-2 gap-4">
              ...
              />
              <Statistics title={t("direct_referral_count")}  value={rewardPromotionData?.referralCount || 0} />
            </div>
            <div className="border-t border-foreground/20 w-full"></div>
            <div className="grid grid-cols-2 gap-4">
              <Statistics title={t("evangelist_level")} value={`V${rewardPromotionData?.communityLevel ? (rewardPromotionData?.communityLevel <= 10 ? rewardPromotionData?.communityLevel : 10) : 0}`} />
              <Statistics
