...
export default function NetWork() {
  ...
  return (
    <>
      <div
        className={`flex items-center bg-white lg:h-10 h-[35px] rounded-full px-3 relative transition-all duration-200 mr-2 ${
          isConnected ? 'cursor-pointer hover:shadow-md hover:scale-105' : ''
        }`}
      ...
      >
        ...
        <span
          ...
          style={{
            color: isConnected ? '#161616' : '#999999',
          }}
        >
          {currentNetwork.name}
        </span>
