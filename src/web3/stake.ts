...
import LongStakingAbi from '@/src/constants/LongStakingAbi.json';
import StakingAbi from '@/src/constants/staking.json';
import DemandStakingAbi from '@/src/constants/DemandStakingAbi.json';
import DistributorAbi from '@/src/constants/DistributorAbi.json';
import NodeStakingAbi from '@/src/constants/NodeStaking.json';
